...
if __name__ == '__main__':
    ...
    model_path = '/opt/models/bvlc_googlenet/' # substitute your path here
    ...
    img = np.float32(PIL.Image.open('/opt/images/rowdy.jpg'))
    for i in range(20):
        print(f'########## {i} ##########')
        img = deepdream(net, img)
        result = PIL.Image.fromarray(img.astype('uint8'))
        result.save(f'/opt/images/result_{i}.jpg')
